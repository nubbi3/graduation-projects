...
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/1.png)
...
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/2.png)


將SD卡利用讀卡器連接到你的裝置上，並打開Raspberry Pi Imager。

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/3.png)

先進行格式化。先點擊選擇操作系統，選擇擦除。

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/4.png)

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/5.png)

然後選擇相應的SD卡

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/6.png)

點擊燒錄。

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/7.png)

點選"是"。

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/8.png)

等待擦除，擦除完畢後點擊繼續。

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/9.png)
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/10.png)

此時可以安裝操作系統，重新選擇適合的操作系統，此處以安裝Ubuntu 20.04版本為例。

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/11.png)
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/12.png)
...
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/13.png)
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/14.png)

按照剛才的操作，重新選擇SD卡，並進行燒錄。

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/15.png)

點擊燒錄，等待燒錄。安裝完成後把SD卡插到樹莓派上。

![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/16.png)
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/17.png)
...
2. 如果沒有顯示器，便需要使用ssh來連接，對於Ubuntu第一次ssh登陸，需要有特定的操作
   ...
   1. 首先可以利用網線或者連接WIFI來讓樹莓派連上網絡，這裏是使用Windows台式機來作為初始連接，打開行動熱點頁面。
      ...
      ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/18.png)
   ...
   7. 通过主机的热点界面观察树莓派是否接入
      ...
      ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/19.png)
...
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/20.png)

1. 以163mail為例，163 mail需要在設置裏，開啟smtp服務功能，然後記住所得到的授權密碼。
   
   ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/21.png)
   
   ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/22.png)
   
   ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/23.png)
   mail.py
...
3. 將腳本加入開機執行文件。這邊由於沒有rc.local，需要自己創建，參考[網址]([ubuntu没有/etc/rc.local解决办法，设置开机自启动_黄宝黄宝的技术博客_51CTO博客](https://blog.51cto.com/u_4048786/3204026))
   ...
   6. 成功收到帶有IP的郵件
      ...
      ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/24.png)
   ...
   8. 通過顯示屏，直接在樹莓派的Terminal 中，通过命令“iw dev”查看无线网卡的标识：
      ...
      ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/26.png)
...
1. 利用杜邦線物理連接樹莓派與FU740
   ...
   1. 把原本版子上的`POWER SW`線換成自己的杜邦線。
     ...
     ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/27.png)
      
     ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/28.png)
   
   2. 把繼電器全部切換成高電平觸發
      
      ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/29.png)
   ...
   4. 將樹莓派上的5V，GND以及訊號線(GPIO)接到繼電哭上的DC+，DC-，IN1上。接好後應如下圖所示。
      ...
      ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/30.png)
      
      ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/31.png)
      ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/32.png)
...
2. 利用[Etcher]([balenaEtcher - Flash OS images to SD cards & USB drives](https://www.balena.io/etcher/))把鏡像燒錄到SD卡上
   ...
   ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/33.png)
...
1. 先下載一個系統鏡像，可以下載一個preinstalled的，在這裏使用[*Unmatched preinstalled server* image Ubuntu server 20.04]([Ubuntu 20.04.4 LTS (Focal Fossa) (u-toyama.ac.jp)](http://ubuntutym2.u-toyama.ac.jp/ubuntu-dvd/20.04/release/))為例子。
   ...
   ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/34.png)
...
![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/35.png)
...
##### 申請網站 register.py與register.html
   ...
   ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/36.png)
...
##### 預約與查詢網站apply.py與apply.html, success.html, fail.html
   ...
   ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/37.png)

   查詢

   ![](https://github.com/nubbi3/graduation-projects/raw/2022-06-15/Photo/38.png)
